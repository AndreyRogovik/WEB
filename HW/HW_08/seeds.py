...
with open('D:\\__Python\\GOIT\\WEB\\HW\\HW_08\\authors.json', 'r', encoding='utf-8') as file:
...
# Завантаження даних з JSON-файлу
with open('D:\\__Python\\GOIT\\WEB\\HW\HW_08\\qoutes.json', 'r', encoding='utf-8') as file:
